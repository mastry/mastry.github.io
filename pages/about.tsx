export default function About() {
    return (
        <>
            <p>
                I&apos;m a long-time computer professional. I&apos;ve been a
                programmer, a systems engineer, a performance engineer, an IT
                director, and an architect but mostly I like to write code and
